...
const ContactFooter = () => {
    ...
    return (
        <div className='w-full h-auto bg-[#6985ac]'  id='contactSection'>
            <div className='w-[90vw] h-full mx-auto px-10 py-5 flex-col gap-y-10 justify-start items-center'>
                ...
                <div className='flex-col flex md:flex-row w-full mx-auto h-auto justify-between items-start gap-4'>
                            ...
                            contactDetails.map((ele) => {
                                return (
                                    <div className='flex flex-col md:flex-row gap-5'>
                                        ...
                                        <a className={`text-gray-50 overflow-auto text-md md:text-xl ${ele.isLink? 'cursor-pointer' : "cursor-default" }`} href={ele.isLink ? ele.data : '#'}>{ele.data}</a>
                                    </div>
                                )
                            })
                        }
